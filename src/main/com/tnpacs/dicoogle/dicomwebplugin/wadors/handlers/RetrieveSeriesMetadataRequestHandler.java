...
public class RetrieveSeriesMetadataRequestHandler extends RequestHandler {
    private static final Logger logger = LoggerFactory.getLogger(RetrieveSeriesMetadataRequestHandler.class);

    @Override
    protected Pattern getPattern() {
        return Patterns.RETRIEVE_SERIES_METADATA;
    }
    ...
    protected void sendResponse(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try {
            ...
            JSONArray metadata = getSeriesMetadata(studyInstanceUID, seriesInstanceUID, retrieveParams);
    ...
    private JSONArray getSeriesMetadata(String studyInstanceUID, String seriesInstanceUID,
                                        RetrieveParameters retrieveParams) throws NotFoundException {
        logger.info("RETRIEVE SERIES METADATA PARAMS: {}", retrieveParams.toString());
